const projectDescriptions = [
    "A Next.js 14 web applications that uses the Fitbit API to track user's health data. Hosting, data storage, and authentication is done using Firebase. Tailwind CSS and Typescript were also used to make the code more readable and easier to maintain.",
    "A Stevens Blueprint project for NYCMesh manage it's wireless sectors that are being used to transport data across city blocks. The website we are developing uses Next.js 14 with Typescript, and Docker as a CI/CD tool.",
